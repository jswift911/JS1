...
const map = {
    ...
    render(snakePointsArray, foodPoint) {
        ...
        this.usedCells.push(foodCell); // Здесь была ошибка, вместо ячейки foodCell была добавлена точка foodPoint.
    },
};
...
const game = {
    ...
    reset() {
        ...
        this.render();
        // Сбрасываем и инициализируем счетчик по новой.
        score.init();
    },
    ...
    tickHandler() {
        ...
        if (this.food.isOnPoint(this.snake.getNextStepHeadPoint())) {
            ...
            this.snake.growUp();
            // При съедании еды, прибавляем счетчик
            score.increment();
    ...
    canMakeStep() {
        ...
        //     nextHeadPoint.x = this.cells[x1_y1];
        // }
...
const score = {
    ...
    init() {
        ...
        this.count = snake.getBody().length - 1;
    ...
    increment() {
        ...
        if (snake.getBody().length <= settings.winFoodCount + 1) {
            this.count++;
    ...
    render() {
        ...
        return this.countEl.innerText = this.count;
    }
};
